...
const CheckoutModal = ({
  ...
  return (
    <>
      <ButtonCustom onClick={() => handleOpen()}>CONTINUE & PAY</ButtonCustom>
      <Modal
        open={open}
        onClose={handleClose}
      ...
      >
        ...
        >
          ...
          <Box >
            <Typography
              sx={{ fontWeight: "700", fontSize: {sm:"32px", xs: "24px" }, lineHeight: "36px" }}
            >
              THANK YOU
            </Typography>
            <Typography
          ...
          <Box sx={{ width: "100%", height: {sm: "140px", xs: "232px"}, display: "flex", flexDirection: {sm: "row", xs: "column"} }}>
            <Box
              sx={{
                width: {sm:"60%", xs: "100%" },
          ...
          <ButtonCustom sx={{ width: "100%" }} onClick={()=> navigate("/")}>BACK TO HOME</ButtonCustom>
        </Box>
      </Modal>
    </>
  );
